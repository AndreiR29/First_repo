...
public class Example3
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Numarul random gernerat este: " + x);
        ...
        switch (x)
        {
            ...
            case 3: {
                System.out.println("Am trei lei. Nu merg la film. Mai am nevoie de 2 lei");
            }
            break;

            case 4: {
                System.out.println("Am patru lei. Nu merg la film. Mai am nevoie de 1 leu");
            }
            break;
